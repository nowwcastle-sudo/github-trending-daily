...
const KO={
  ...
  "footer.note":"GitHub Trending 기준 · 요약은 저장소 README에 근거한 AI 분석입니다","footer.subscribe":"구독","footer.feedCurrent":"현재 목록 (Atom)","footer.feedChanges":"신규·재진입 (Atom)","scroll.top":"페이지 맨 위로 이동","readme.dialog":"README 뷰어","readme.default":"기본","readme.github":"GitHub ↗","readme.close":"README 뷰어 닫기","readme.loading":"불러오는 중…","readme.view":"README 전체 보기","readme.unavailable":"README를 확인할 수 없어요.","readme.direct":"GitHub에서 직접 보기 ↗",
...
const JA={
  ...
  "footer.note":"GitHub Trendingを基準 · 要約はリポジトリREADMEに基づくAI分析です","footer.subscribe":"購読","footer.feedCurrent":"現在のリポジトリ (Atom)","footer.feedChanges":"新規・再登場 (Atom)","scroll.top":"ページ上部へ","readme.dialog":"READMEビューアー","readme.default":"既定","readme.github":"GitHub ↗","readme.close":"READMEビューアーを閉じる","readme.loading":"読み込み中…","readme.view":"READMEを見る","readme.unavailable":"READMEを利用できません。","readme.direct":"GitHubで直接見る ↗",
