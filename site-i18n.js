...
const EN={
  ...
  // Names the bare numeral in the rail badge; without it the live region announces just "1".
  "nav.activeFilters":"Active filters",
  ...
  "account.retry":"Sign-in is ready. Click the button again.",
  // Shown while the Firebase client is still unloaded: an anonymous visitor is on browser storage
  // and the Sign-in button is the way out of it, so the status names the action, not a wait.
  "account.guest":"Sign in to sync favorites across devices.",
  ...
  // Label in Name (WCAG 2.5.3): the pill renders {name}, so its accessible name opens with it.
  "filter.removePill":"{name} filter — remove",
  "filter.conflictExcludeAi":"Unavailable while the AI and machine learning field filter is on",
  "filter.conflictAiField":"Unavailable while Exclude AI is on",
  ...
  // Touch only: on a hover layout the summary follows the pointer and carries no close control.
  "tooltip.close":"Close repository summary",
  ...
  "history.title":"Star history","history.explanation":"Total stars observed directly by this site (every 30 minutes) · the dashed line marks anchors back-calculated from GitHub Trending period totals","history.observedSince":"Observing since","history.waiting":"Waiting for the first observation","history.singleObservation":"1 observation",
  // Replaces the value-free "Star trend": the sparkline's label now carries where the line ends,
  // how long it runs and how far it moved. Two span forms rather than one, so no locale has to
  // print "1 days".
  "history.ariaSummary":"Star trend — {total} total stars, {gain} over {span}",
  "history.ariaSpanDay":"1 day",
  "history.ariaSpanDays":"{days} days",
...
const KO={
  ...
  "nav.account":"로그인","nav.history":"이력","nav.export":"내보내기","nav.ariaAccount":"로그인 — 계정·동기화 패널","nav.ariaExplore":"탐색 패널","nav.ariaHistory":"이력 패널","nav.ariaExport":"내보내기 패널","nav.titleAccount":"로그인 (a)","nav.titleExplore":"탐색 (e)","nav.titleHistory":"이력 (h)","nav.titleExport":"내보내기 (x)","nav.groups":"패널 구획","nav.activeFilters":"적용된 필터","filter.copyLink":"링크 복사","filter.compact":"간단히 보기","filter.removePill":"{name} 필터 제거","filter.conflictExcludeAi":"AI·머신러닝 분야 필터를 켠 동안에는 사용할 수 없습니다","filter.conflictAiField":"AI 분야 제외를 켠 동안에는 사용할 수 없습니다","filter.statusPrompt":"","tooltip.heldRetry":"다음 갱신(6시간마다) 때 다시 시도합니다.",
  "sidebar.title":"대시보드 메뉴","sidebar.close":"패널 닫기","refresh.loading":"최근 갱신 시각: 불러오는 중…","refresh.next":"다음 갱신 시각: —","refresh.cadence":"6시간마다 갱신",
  "account.title":"계정과 동기화","account.preparing":"로그인 준비 중이에요.","account.retry":"로그인 준비가 끝났어요. 버튼을 다시 눌러 주세요.","account.guest":"로그인하면 즐겨찾기를 여러 기기에서 동기화할 수 있어요.","account.syncLabel":"브라우저 동기화. {message}","account.login":"Google로 로그인","account.logout":"로그아웃","account.unavailable":"Google 동기화를 사용할 수 없어 이 브라우저에 저장합니다.",
...
const ZH={
  ...
  "tooltip.dialog":"仓库摘要","tooltip.close":"关闭仓库摘要","tooltip.unavailable":"所选网站语言的摘要不可用。","tooltip.held":"摘要正在验证中。详情请查看 README。","tooltip.aiNote":"由 AI 根据已验证的仓库 README 生成","tooltip.goal":"项目目标","tooltip.usage":"使用方法","tooltip.pros":"优点","tooltip.cons":"注意事项","tooltip.fit":"适用场景","tooltip.trend":"趋势说明","tooltip.hide":"不感兴趣",
...
const ES={
  ...
  "account.title":"Cuenta y sincronización","account.preparing":"Preparando el inicio de sesión.","account.retry":"El inicio de sesión está listo. Pulsa el botón otra vez.","account.guest":"Inicia sesión para sincronizar tus favoritos entre dispositivos.","account.syncLabel":"Sincronización del navegador. {message}","account.login":"Iniciar sesión con Google","account.logout":"Cerrar sesión",
...
const JA={
  ...
  "nav.account":"ログイン","nav.history":"履歴","nav.export":"エクスポート","nav.ariaAccount":"ログイン — アカウント・同期パネル","nav.ariaExplore":"探索パネル","nav.ariaHistory":"履歴パネル","nav.ariaExport":"エクスポートパネル","nav.titleAccount":"ログイン (a)","nav.titleExplore":"探索 (e)","nav.titleHistory":"履歴 (h)","nav.titleExport":"エクスポート (x)","nav.groups":"パネルセクション","nav.activeFilters":"適用中のフィルター","filter.copyLink":"リンクをコピー","filter.compact":"コンパクト表示","filter.removePill":"{name} フィルターを解除","filter.conflictExcludeAi":"分野「AI・機械学習」を選択している間は使用できません","filter.conflictAiField":"「AIを除外」を有効にしている間は使用できません","filter.statusPrompt":"","tooltip.heldRetry":"次回の更新（6時間ごと）で再試行します。",
  "sidebar.title":"ダッシュボードメニュー","sidebar.close":"パネルを閉じる","refresh.loading":"最終更新：読み込み中…","refresh.next":"次回更新：—","refresh.cadence":"6時間ごとに更新",
  "account.title":"アカウントと同期","account.preparing":"ログインを準備しています。","account.retry":"ログインの準備ができました。ボタンをもう一度押してください。","account.guest":"ログインすると、お気に入りを複数の端末で同期できます。","account.syncLabel":"ブラウザー同期。{message}","account.login":"Googleでログイン","account.logout":"ログアウト",
  ...
  "tooltip.dialog":"リポジトリ要約","tooltip.close":"リポジトリ要約を閉じる","tooltip.unavailable":"選択したサイト言語の要約を利用できません。","tooltip.held":"要約を検証中です。詳細は README をご覧ください。","tooltip.aiNote":"検証済みのリポジトリREADMEを基にAIが生成した要約","tooltip.goal":"プロジェクトの目的","tooltip.usage":"使い方","tooltip.pros":"長所","tooltip.cons":"注意点","tooltip.fit":"適した用途","tooltip.trend":"トレンドメモ","tooltip.hide":"興味なし",
  ...
  "classification.form":"形態","classification.field":"分野・技術","classification.ai":"AI関連","history.loading":"📈 スター履歴を読み込み中…","history.failed":"📈 スター履歴を読み込めませんでした","history.title":"スター履歴","history.explanation":"このサイトが直接観測したスター総数（30分間隔）· 破線は GitHub Trending の期間集計から逆算したアンカー","history.observedSince":"観測開始","history.ariaSummary":"スター推移 — 総スター {total}、{span}で{gain}","history.ariaSpanDay":"1日間","history.ariaSpanDays":"{days}日間","history.waiting":"観測開始待ち","history.singleObservation":"観測1回"
};
