...
const EN={
  ...
  "sidebar.close":"Close Explore sidebar",
  "refresh.loading":"Last refreshed: loading…",
  "refresh.next":"Next refresh: —",
  "refresh.cadence":"Refreshes every 2 hours",
...
const KO={
  ...
  "sidebar.title":"대시보드 메뉴","sidebar.close":"탐색 사이드바 닫기","refresh.loading":"최근 갱신 시각: 불러오는 중…","refresh.next":"다음 갱신 시각: —","refresh.cadence":"2시간마다 갱신",
  ...
  "badges.aria":"배지 안내","badges.title":"배지 안내","badges.streak":"연속된 날짜에 Trending에서 관측","badges.change":"직전 관측일 대비 총 스타 변화","badges.hot":"선택 기간 스타 증가 1,000 이상","badges.new":"baseline 이후 처음 관측","badges.reentered":"직전 목록에서 빠졌다가 다시 등장","badges.newLabel":"신규","badges.reenteredLabel":"재진입",
  ...
  "footer.note":"GitHub Trending 기준 · 요약은 저장소 README에 근거한 AI 분석입니다","scroll.top":"페이지 맨 위로 이동","readme.dialog":"README 뷰어","readme.default":"기본","readme.github":"GitHub ↗","readme.close":"README 뷰어 닫기","readme.loading":"불러오는 중…","readme.view":"README 전체 보기","readme.unavailable":"README를 확인할 수 없어요.","readme.direct":"GitHub에서 직접 보기 ↗",
  "tooltip.dialog":"저장소 요약","tooltip.unavailable":"선택한 사이트 언어의 요약을 확인할 수 없어요.","tooltip.language":"요약 언어","tooltip.aiNote":"검증된 저장소 README를 바탕으로 AI가 생성한 요약","tooltip.goal":"프로젝트 목표","tooltip.usage":"실행 방법","tooltip.pros":"장점","tooltip.cons":"단점·주의점","tooltip.fit":"어울리는 상황","tooltip.trend":"트렌드 한 줄 평","tooltip.hide":"관심 없음",
  "repo.contributors":"기여자","repo.issues":"열린 이슈·PR","repo.commit":"커밋","repo.release":"릴리스","repo.repository":"저장소","repo.aria":"{name} 저장소","repo.favorite":"즐겨찾기","repo.favoriteAdd":"즐겨찾기 추가","repo.favoriteRemove":"즐겨찾기 해제","repo.forks":"forks","repo.totalStars":"total stars","classification.form":"형태","classification.field":"분야·기술","classification.ai":"AI 관련","history.loading":"📈 스타 추이를 불러오는 중…","history.failed":"📈 스타 추이를 불러오지 못했어요","period.recent":"최근","period.today":"오늘","period.thisWeek":"이번 주","period.thisMonth":"이번 달","refresh.lastAt":"최근 갱신 시각: {time}","refresh.nextAt":"다음 갱신 시각: {time}","refresh.unknown":"확인할 수 없음"
};
...
const ZH={
  ...
  "sidebar.title":"面板菜单","sidebar.close":"关闭探索侧栏","refresh.loading":"最近更新：加载中…","refresh.next":"下次更新：—","refresh.cadence":"每 2 小时更新",
  ...
  "result.all":"正在显示全部仓库。","result.clear":"清除探索筛选","hidden.title":"管理隐藏仓库","hidden.restoreAll":"全部恢复","exits.title":"最近离榜","exits.note":"上一份确认列表中存在、但当前列表中不存在的仓库。",
  ...
  "badges.aria":"徽章说明","badges.title":"徽章说明","badges.streak":"连续多日出现在 Trending","badges.change":"自上次观测日起总星标变化","badges.hot":"所选期间新增至少 1,000 个星标","badges.new":"基线后首次观测","badges.reentered":"离开上一列表后重新上榜","badges.newLabel":"新增","badges.reenteredLabel":"重新上榜",
  ...
  "footer.note":"基于 GitHub Trending · 摘要是以仓库 README 为依据的 AI 分析","scroll.top":"返回顶部","readme.dialog":"README 查看器","readme.default":"默认","readme.github":"GitHub ↗","readme.close":"关闭 README 查看器","readme.loading":"加载中…","readme.view":"查看 README","readme.unavailable":"README 暂不可用。","readme.direct":"直接在 GitHub 查看 ↗",
  "tooltip.dialog":"仓库摘要","tooltip.unavailable":"所选网站语言的摘要不可用。","tooltip.aiNote":"由 AI 根据已验证的仓库 README 生成","tooltip.goal":"项目目标","tooltip.usage":"使用方法","tooltip.pros":"优点","tooltip.cons":"注意事项","tooltip.fit":"适用场景","tooltip.trend":"趋势说明","tooltip.hide":"不感兴趣",
  ...
  "classification.form":"形态","classification.field":"领域与技术","classification.ai":"AI 相关","history.loading":"📈 正在加载星标历史…","history.failed":"📈 无法加载星标历史"
};
...
const ES={
  ...
  "sidebar.title":"Menú del panel","sidebar.close":"Cerrar barra Explorar","refresh.loading":"Última actualización: cargando…","refresh.next":"Próxima actualización: —","refresh.cadence":"Se actualiza cada 2 horas",
  ...
  "result.all":"Mostrando todos los repositorios.","result.clear":"Borrar filtros de Explorar","hidden.title":"Gestionar repositorios ocultos","hidden.restoreAll":"Restaurar todo","exits.title":"Salidas recientes","exits.note":"Repositorios presentes en la lista confirmada anterior, pero no en la actual.",
  ...
  "classification.form":"Formato","classification.field":"Área y tecnología","classification.ai":"Relacionado con IA","history.loading":"📈 Cargando historial de estrellas…","history.failed":"📈 No se pudo cargar el historial de estrellas"
};
...
const JA={
  ...
  "sidebar.title":"ダッシュボードメニュー","sidebar.close":"探索サイドバーを閉じる","refresh.loading":"最終更新：読み込み中…","refresh.next":"次回更新：—","refresh.cadence":"2時間ごとに更新",
  ...
  "result.all":"すべてのリポジトリを表示しています。","result.clear":"探索フィルターをクリア","hidden.title":"非表示リポジトリを管理","hidden.restoreAll":"すべて復元","exits.title":"最近の離脱","exits.note":"前回の確定リストにはあり、現在のリストにはないリポジトリです。",
  ...
  "badges.aria":"バッジガイド","badges.title":"バッジガイド","badges.streak":"連続した日付でTrendingに掲載","badges.change":"前回観測日からの総スター数の変化","badges.hot":"選択期間に1,000以上のスター増加","badges.new":"ベースライン後に初めて観測","badges.reentered":"前回リストから外れた後に再登場","badges.newLabel":"新規","badges.reenteredLabel":"再登場",
  ...
  "footer.note":"GitHub Trendingを基準 · 要約はリポジトリREADMEに基づくAI分析です","scroll.top":"ページ上部へ","readme.dialog":"READMEビューアー","readme.default":"既定","readme.github":"GitHub ↗","readme.close":"READMEビューアーを閉じる","readme.loading":"読み込み中…","readme.view":"READMEを見る","readme.unavailable":"READMEを利用できません。","readme.direct":"GitHubで直接見る ↗",
  "tooltip.dialog":"リポジトリ要約","tooltip.unavailable":"選択したサイト言語の要約を利用できません。","tooltip.aiNote":"検証済みのリポジトリREADMEを基にAIが生成した要約","tooltip.goal":"プロジェクトの目的","tooltip.usage":"使い方","tooltip.pros":"長所","tooltip.cons":"注意点","tooltip.fit":"適した用途","tooltip.trend":"トレンドメモ","tooltip.hide":"興味なし",
  ...
  "classification.form":"形態","classification.field":"分野・技術","classification.ai":"AI関連","history.loading":"📈 スター履歴を読み込み中…","history.failed":"📈 スター履歴を読み込めませんでした"
};
