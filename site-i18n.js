...
const KO={
  ...
  "account.title":"계정과 동기화","account.preparing":"로그인 준비 중이에요.","account.guest":"로그인하면 즐겨찾기를 여러 기기에서 동기화할 수 있어요.","account.syncLabel":"브라우저 동기화. {message}","account.login":"Google로 로그인","account.logout":"로그아웃","account.unavailable":"Google 동기화를 사용할 수 없어 이 브라우저에 저장합니다.",
...
const ZH={
  ...
  "account.title":"账户与同步","account.preparing":"正在准备登录。","account.guest":"登录后即可在多台设备间同步收藏。","account.syncLabel":"浏览器同步。{message}","account.login":"使用 Google 登录","account.logout":"退出登录",
...
const ES={
  ...
  "account.title":"Cuenta y sincronización","account.preparing":"Preparando el inicio de sesión.","account.guest":"Inicia sesión para sincronizar tus favoritos entre dispositivos.","account.syncLabel":"Sincronización del navegador. {message}","account.login":"Iniciar sesión con Google","account.logout":"Cerrar sesión",
...
const JA={
  ...
  "account.title":"アカウントと同期","account.preparing":"ログインを準備しています。","account.guest":"ログインすると、お気に入りを複数の端末で同期できます。","account.syncLabel":"ブラウザー同期。{message}","account.login":"Googleでログイン","account.logout":"ログアウト",
