...
const KO={
  ...
  "tooltip.dialog":"저장소 요약","tooltip.language":"요약 언어","tooltip.aiNote":"검증된 저장소 README를 바탕으로 AI가 생성한 요약","tooltip.goal":"프로젝트 목표","tooltip.usage":"실행 방법","tooltip.pros":"장점","tooltip.cons":"단점·주의점","tooltip.fit":"어울리는 상황","tooltip.trend":"트렌드 한 줄 평","tooltip.hide":"관심 없음",
...
const ZH={
  ...
  "tooltip.dialog":"仓库摘要","tooltip.aiNote":"由 AI 根据已验证的仓库 README 生成","tooltip.goal":"项目目标","tooltip.usage":"使用方法","tooltip.pros":"优点","tooltip.cons":"注意事项","tooltip.fit":"适用场景","tooltip.trend":"趋势说明","tooltip.hide":"不感兴趣",
...
const ES={
  ...
  "tooltip.dialog":"Resumen del repositorio","tooltip.aiNote":"Resumen generado por IA a partir del README verificado del repositorio","tooltip.goal":"Objetivo del proyecto","tooltip.usage":"Cómo usarlo","tooltip.pros":"Ventajas","tooltip.cons":"Precauciones","tooltip.fit":"Uso recomendado","tooltip.trend":"Nota de tendencia","tooltip.hide":"No me interesa",
...
const JA={
  ...
  "tooltip.dialog":"リポジトリ要約","tooltip.aiNote":"検証済みのリポジトリREADMEを基にAIが生成した要約","tooltip.goal":"プロジェクトの目的","tooltip.usage":"使い方","tooltip.pros":"長所","tooltip.cons":"注意点","tooltip.fit":"適した用途","tooltip.trend":"トレンドメモ","tooltip.hide":"興味なし",
