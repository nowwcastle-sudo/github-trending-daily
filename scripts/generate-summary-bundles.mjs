...
export function measureSummaryBundlePlan(items, { inputTokenCap, outputTokenCap, retryAttempts } = {}) {
  ...
  return Object.freeze({
    ...
    outputTokenCap,
    retryAttempts,
    plannedMaximumCostUsd: Number(((requiredInputReservation * SONNET_5_INPUT_USD_PER_MILLION + requiredOutputAllocation * SONNET_5_OUTPUT_USD_PER_MILLION) / 1_000_000).toFixed(6)),
