...
export const FIELD_JUDGMENTS = [
  {
    ...
    criteria: {
      true: "The repository's own purpose is AI or ML: models, training, inference, agents, LLM tooling, embeddings, computer vision, or NLP. A tool whose reason to exist is to build, run, evaluate, or orchestrate AI counts.",
      false: "AI or ML is incidental. The repository carries an `ai`-like topic, ships an optional AI feature, embeds vectors as one storage type among many, or is merely usable by an AI agent, while its actual subject is something else such as storage, databases, or diagrams.",
    },
  },
  {
    id: "web-app",
    ...
    criteria: {
      true: "Its subject is web or mobile application development: browser front-ends, UI frameworks and component libraries, web or mobile apps, or browser extensions.",
      false: "It is backend, infrastructure, or general-purpose software that merely happens to be written in a web language or to expose an HTTP interface.",
    },
  },
  {
    id: "dev-tools",
    ...
    criteria: {
      true: "It exists to support the act of building software: editors, compilers, linters, debuggers, SDKs, code review and code generation tools, build tooling, or developer CLIs.",
      false: "Its users are not developers acting as developers, or it is an end-user product, a runtime service, or a learning resource that happens to be about programming.",
    },
  },
  {
    id: "data",
    ...
    criteria: {
      true: "Its subject is data itself: databases and storage engines, query engines, data pipelines and warehouses, analytics, or object and file storage systems.",
      false: "It merely persists its own state, reads a config file, or depends on a database to do something else.",
    },
  },
  {
    id: "devops",
    ...
    criteria: {
      true: "Its subject is infrastructure and operations: containers and orchestration, CI/CD, provisioning, cloud platform tooling, monitoring, logging, or observability.",
      false: "It ships a Dockerfile or a CI config for its own development, which every project does, and is otherwise about something else.",
    },
  },
  {
    id: "security",
    ...
    criteria: {
      true: "Its subject is protecting systems or people: vulnerability discovery, penetration testing, auditing, cryptography, secret management, authentication and authorization systems, or privacy-preserving tooling.",
      false: "It states that it is secure, handles credentials as part of ordinary operation, or lists a `privacy` topic, while its purpose lies elsewhere.",
    },
  },
  {
    id: "productivity",
    ...
    criteria: {
      true: "It is an end-user product for knowledge or personal work: note-taking, knowledge management, task and project management, communication, finance, media, or desktop productivity applications.",
      false: "Its users are developers acting as developers, or it is a library, an infrastructure component, or a learning resource.",
    },
  },
  {
    id: "systems",
    ...
    criteria: {
      true: "Its subject is operating systems and kernels, drivers, embedded or firmware development, robotics, hardware, or on-device and smart-home systems.",
      false: "It is written in a systems language such as Rust, C, or Go but is an ordinary application, service, or library.",
    },
  },
  {
    id: "learning",
    ...
    criteria: {
      true: "Its value to a reader is educational: tutorials, courses, books, curricula, interview or study preparation, `awesome`-style curated resource lists, or software whose stated purpose is helping people learn and memorise.",
      false: "It is working software that happens to have good documentation or an examples directory.",
    },
  },
];
...
export const FORM_JUDGMENTS = [
  {
    ...
    criteria: {
      true: "It is an agent, an agent harness, or an agent framework: something that decides on and executes a sequence of actions toward a goal.",
      false: "It is a single-turn AI feature, a model wrapper, or a tool an agent can call. Being designed for use *by* an agent does not make a repository an agent.",
    },
  },
  {
    id: "mcp",
    ...
    criteria: {
      true: "MCP is part of what it ships: it serves, consumes, proxies, or provides tooling for the protocol.",
      false: "MCP appears only as a listed topic, a roadmap item, or a passing mention, and nothing in the repository implements it.",
    },
  },
  {
    id: "plugin-skill",
    ...
    criteria: {
      true: "It is packaged to extend a host: an agent skill, an editor or browser extension, or a plugin for another product. It needs that host to do anything.",
      false: "It is a standalone program, service, or library, even if it happens to support a plugin system of its own.",
    },
  },
  {
    id: "ide",
    ...
    criteria: {
      true: "It provides the environment a developer writes code in: an editor, an IDE, or a hosted or containerised development workspace.",
      false: "It is a plugin or extension *for* an editor, or a command-line tool used alongside one.",
    },
  },
  {
    id: "library",
    ...
    criteria: {
      true: "Its intended use is being depended on in someone else's codebase and called from their code.",
      false: "Its intended use is being run — as an application, a service, or a command-line tool — even when it also publishes a package.",
    },
  },
  {
    id: "framework",
    ...
    criteria: {
      true: "Users build inside it, following its lifecycle, conventions, and extension points.",
      false: "Users call it from code they structure themselves, which makes it a library rather than a framework.",
    },
  },
  {
    id: "cli",
    ...
    criteria: {
      true: "The command line is how it is mainly used, including terminal user interfaces.",
      false: "Its primary interface is a graphical or web UI, a library API, or a long-running service, even when a helper command exists for setup or administration.",
    },
  },
];
