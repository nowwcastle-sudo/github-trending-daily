...
function approvedGeneratedCommitPath(relative) {
  return ["index.html", "data/repo-summaries.json", "data/observation-db.pointer.json", "data/readme-state.json", "data/membership-status.json", "data/latest.json", "data/translation-sources.json", "feed.xml", "changes.xml", "data/star-anchors.json", "star-history.json"].includes(relative)
